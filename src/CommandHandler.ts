...
export default class CommandHandler {
  ...
  private async handleSetLanguage(interaction: ChatInputCommandInteraction) {
  ...
  private async handleTranslate(interaction: ChatInputCommandInteraction) {
    if (!interaction.isCommand()) return;
  ...
  public async handleAutoTranslation(message: Message) {
